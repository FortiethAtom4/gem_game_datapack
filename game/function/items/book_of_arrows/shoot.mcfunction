...
execute anchored eyes run summon minecraft:splash_potion ^ ^ ^1 {Tags:["projectile"],Item:{id:"minecraft:fire_charge",count:1,components:{"minecraft:potion_contents":{potion:"minecraft:healing"}}}}
